...
\begin{resume}
    ...
    \begin{tabularx}{\textwidth}{lXcl}
        &                   & \raisebox{-3pt}{\faGithub} & github.com/gz     \\
        &                   & \raisebox{-3pt}{\Envelope} & gz@feldera.com    \\
        &                   & \raisebox{-3pt}{\Phone}    & +1  650 250 9046  \\
    \end{tabularx}
    ...
    \textbf{Feldera}, Palo Alto, USA \vspace{2mm}\\\vspace{1mm}%
    \textsl{Co-Founder} \hfill \textbf{May 2023 -- today}\\
    Building the next-generation data analytics platform.

    \textbf{VMware, Research Group}, Palo Alto, USA \vspace{2mm}\\\vspace{1mm}%
    \textsl{Senior Researcher} \hfill \textbf{March 2018 -- April 2023}\\
    ...
    % Manager: David Tennenhouse, Israel Cideon
    ...
    Mihai Budiu, Leonid Ryzhyk, Gerd Zellweger, Ben Pfaff, Lalith Suresh, Simon Kassing, Abhinav Gyawali, Matei Budiu, Tej Chajed, Frank McSherry, Val Tannen.
    ``\textbf{DBSP: automatic incremental view maintenance for rich query languages.}'',
    \textsl{The VLDB Journal} (VLDB, Journal, July 2025).

    Marcos K. Aguilera, Emmanuel Amaro, Nadav Amit, Erika Hunhoff, Anil Yelam, Gerd Zellweger.
    ``\textbf{Memory Disaggregation: Why now and what are the challenges.}'',
    \textsl{ACM SIGOPS Operating Systems Review} (SIGOPS, Journal, 2023).

    Matthias Brun, Reto Achermann, Tej Chajed, Jon Howell, Gerd Zellweger, Andrea Lattuada.
    ``\textbf{Beyond Isolation: OS verification as a foundation for correct applications.}'',
    \textsl{Proceedings of the 19th Workshop on Hot Topics in Operating Systems} (HotOS, Providence, USA, July 2023).
    ...
    ``\textbf{Sharding the State Machine: Automated Modular Reasoning for Complex Concurrent Systems.}''
    \textsl{Proceedings of the 17th USENIX Symposium on Operating Systems Design and Implementation} (OSDI, Boston, USA, July 2023).
